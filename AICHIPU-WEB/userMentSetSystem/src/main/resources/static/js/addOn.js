...
$(function() {
    ...
    function initNyugakuNendo() {
        ...
        $("#nyuGakuNendo").val(gakuSekiBn.substr(0, 4) + "年度");
        //}
    ...
    function setDefaultVal3() {
        ...
        //16 Linuxホームディレクトリ(IST)
        $("#otherItem16").val("\\\\ia203\\home\\student\\" + riYouShaId);

        //17 Linuxホームディレクトリ(CIS)
        $("#otherItem17").val("/res/" + riYouShaId);

        //18 WWWホームディレクトリ(CIS)
        $("#otherItem18").val("/cis/home/" + riYouShaId);

        //19 Windowsホームディレクトリ(演習室1)
        $("#otherItem19").val("/cis/home/" + riYouShaId);
