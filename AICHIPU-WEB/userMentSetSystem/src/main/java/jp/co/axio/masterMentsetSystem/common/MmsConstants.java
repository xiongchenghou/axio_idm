...
public class MmsConstants {
	...
	/**MSTO0017M0101JP=現行パスワードが一致しません。*/
	public static final String MSG_MSTO0017M0101JP = "MSTO0017M0101JP";
	/**MSTO0017M0101EN=The current password does not match.*/
	public static final String MSG_MSTO0017M0101EN = "MSTO0017M0101EN";
	/**MSTO0017M0102JP=「新パスワード」の有効性チェックが失敗しました。*/
	public static final String MSG_MSTO0017M0102JP = "MSTO0017M0102JP";
	/**MSTO0017M0102EN=The validity check for the new password has failed.*/
	public static final String MSG_MSTO0017M0102EN = "MSTO0017M0102EN";
	/**MSTO0017M0103JP=「新パスワード」と「新パスワード（確認）」が一致しません。*/
	public static final String MSG_MSTO0017M0103JP = "MSTO0017M0103JP";
	/**MSTO0017M0103EN=The new password and its confirmation do not match.*/
	public static final String MSG_MSTO0017M0103EN = "MSTO0017M0103EN";
