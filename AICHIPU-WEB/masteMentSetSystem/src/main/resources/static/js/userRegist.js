...
$(function() {
    ...
    $('#organizationSelect').on('click', function(e) {
        ...
        $('#callReturn').val("");
        $.ajax({
            url: webAppName + "/authOrgCodeList",
            type: "POST",
    ...
    $("#btn_back").on("click", function(e) {
        var m = "変更が保存されていないため、変更した内容が破棄されますがよろしいでしょうか？";
        var that = this;
