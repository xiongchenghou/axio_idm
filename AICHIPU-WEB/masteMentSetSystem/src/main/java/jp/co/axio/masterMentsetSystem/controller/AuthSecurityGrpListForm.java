...
@Setter
@Getter
public class AuthSecurityGrpListForm implements Serializable {
	...
	/** セキュリティグループID　*/
	public String dailogSecurityGroupCode;

	/** グループ名 */
	public String dailogGroupName;
	...
	/** 検索結果一覧 */
	public List<AuthSecurityGrpListDto> listGroupItems;
	...
	/** checked SecurityGroupCode */
	public String checkSecurityGroupCode;
}
